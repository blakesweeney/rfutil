...
pub struct EntityModelV1Term {
    ...
    #[serde(rename = "term_replaced_by", skip_serializing_if = "Option::is_none")]
    pub term_replaced_by: Option<String>,
    ...
    #[serde(rename = "obo_definition_citation", skip_serializing_if = "Option::is_none")]
    pub obo_definition_citation: Option<Vec<models::V1OboDefinitionCitation>>,
    #[serde(rename = "obo_xref", skip_serializing_if = "Option::is_none")]
    pub obo_xref: Option<Vec<models::V1OboXref>>,
    #[serde(rename = "obo_synonym", skip_serializing_if = "Option::is_none")]
    pub obo_synonym: Option<Vec<models::V1OboSynonym>>,
    #[serde(rename = "is_preferred_root", skip_serializing_if = "Option::is_none")]
    pub is_preferred_root: Option<bool>,
    #[serde(rename = "links", skip_serializing_if = "Option::is_none")]
    pub links: Option<Vec<models::Link>>,
}

impl EntityModelV1Term {
    pub fn new() -> EntityModelV1Term {
        EntityModelV1Term {
            iri: None,
            lang: None,
            description: None,
