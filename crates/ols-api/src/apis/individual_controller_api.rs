...
pub fn get_all_individuals(
    configuration: &configuration::Configuration,
    iri: Option<&str>,
    short_form: Option<&str>,
    obo_id: Option<&str>,
    lang: Option<&str>,
) -> Result<models::PagedModelV1Individual, Error<GetAllIndividualsError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetAllIndividualsError> =
...
pub fn get_all_individuals1(
    configuration: &configuration::Configuration,
    iri: &str,
    lang: Option<&str>,
) -> Result<models::PagedModelV1Individual, Error<GetAllIndividuals1Error>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetAllIndividuals1Error> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn get_all_individuals_by_id_and_is_defining_ontology(
    configuration: &configuration::Configuration,
    iri: Option<&str>,
    short_form: Option<&str>,
    obo_id: Option<&str>,
    lang: Option<&str>,
) -> Result<models::PagedModelV1Individual, Error<GetAllIndividualsByIdAndIsDefiningOntologyError>>
{
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetAllIndividualsByIdAndIsDefiningOntologyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn get_all_individuals_by_id_and_is_defining_ontology1(
    configuration: &configuration::Configuration,
    iri: &str,
    lang: Option<&str>,
) -> Result<models::PagedModelV1Individual, Error<GetAllIndividualsByIdAndIsDefiningOntology1Error>>
{
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetAllIndividualsByIdAndIsDefiningOntology1Error> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
