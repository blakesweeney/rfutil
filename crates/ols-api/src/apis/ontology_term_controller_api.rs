...
pub fn ancestors(
    ...
    iri: &str,
    lang: Option<&str>,
) -> Result<models::PagedModelV1Term, Error<AncestorsError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AncestorsError> =
...
pub fn children(
    ...
    iri: &str,
    lang: Option<&str>,
) -> Result<models::PagedModelV1Term, Error<ChildrenError>> {
    let local_var_configuration = configuration;
...
pub fn descendants(
    ...
    iri: &str,
    lang: Option<&str>,
) -> Result<models::PagedModelV1Term, Error<DescendantsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DescendantsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn get_hierarchical_ancestors(
    configuration: &configuration::Configuration,
    onto: &str,
    iri: &str,
    lang: Option<&str>,
) -> Result<models::PagedModelV1Term, Error<GetHierarchicalAncestorsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetHierarchicalAncestorsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn get_hierarchical_children(
    configuration: &configuration::Configuration,
    onto: &str,
    iri: &str,
    lang: Option<&str>,
) -> Result<models::PagedModelV1Term, Error<GetHierarchicalChildrenError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetHierarchicalChildrenError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn get_hierarchical_descendants(
    configuration: &configuration::Configuration,
    onto: &str,
    iri: &str,
    lang: Option<&str>,
) -> Result<models::PagedModelV1Term, Error<GetHierarchicalDescendantsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetHierarchicalDescendantsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn get_hierarchical_parents(
    configuration: &configuration::Configuration,
    onto: &str,
    iri: &str,
    lang: Option<&str>,
) -> Result<models::PagedModelV1Term, Error<GetHierarchicalParentsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetHierarchicalParentsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn get_parents(
    ...
    iri: &str,
    lang: Option<&str>,
) -> Result<models::PagedModelV1Term, Error<GetParentsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetParentsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn get_preferred_roots(
    configuration: &configuration::Configuration,
    onto: &str,
    include_obsoletes: Option<bool>,
    lang: Option<&str>,
) -> Result<models::PagedModelV1Term, Error<GetPreferredRootsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetPreferredRootsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn get_roots(
    ...
    include_obsoletes: Option<bool>,
    lang: Option<&str>,
) -> Result<models::PagedModelV1Term, Error<GetRootsError>> {
    let local_var_configuration = configuration;
...
pub fn get_term(
    ...
    iri: &str,
    lang: Option<&str>,
) -> Result<models::EntityModelV1Term, Error<GetTermError>> {
    let local_var_configuration = configuration;
...
pub fn graph_js_tree(
...
) -> Result<String, Error<GraphJsTreeError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GraphJsTreeError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn graph_js_tree_children(
    configuration: &configuration::Configuration,
    onto: &str,
    iri: &str,
    nodeid: &str,
    lang: Option<&str>,
) -> Result<String, Error<GraphJsTreeChildrenError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GraphJsTreeChildrenError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn graph_json(
    ...
    iri: &str,
    lang: Option<&str>,
) -> Result<String, Error<GraphJsonError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GraphJsonError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn related(
    ...
    property_iri: &str,
    lang: Option<&str>,
) -> Result<models::PagedModelV1Term, Error<RelatedError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        onto = crate::apis::urlencode(onto),
        iri = crate::apis::urlencode(iri),
        property_iri = crate::apis::urlencode(property_iri)
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub fn term_ancestors_by_ontology(
    configuration: &configuration::Configuration,
    onto: &str,
    iri: Option<&str>,
    ...
    id: Option<&str>,
    lang: Option<&str>,
) -> Result<models::PagedModelV1Term, Error<TermAncestorsByOntologyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TermAncestorsByOntologyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn term_children_by_ontology(
    configuration: &configuration::Configuration,
    onto: &str,
    iri: Option<&str>,
    short_form: Option<&str>,
    ...
    id: Option<&str>,
    lang: Option<&str>,
) -> Result<models::PagedModelV1Term, Error<TermChildrenByOntologyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TermChildrenByOntologyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn term_descendants_by_ontology(
    configuration: &configuration::Configuration,
    onto: &str,
    iri: Option<&str>,
    short_form: Option<&str>,
    ...
    id: Option<&str>,
    lang: Option<&str>,
) -> Result<models::PagedModelV1Term, Error<TermDescendantsByOntologyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TermDescendantsByOntologyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn term_hierarchical_ancestors_by_ontology(
    configuration: &configuration::Configuration,
    onto: &str,
    iri: Option<&str>,
    short_form: Option<&str>,
    ...
    id: Option<&str>,
    lang: Option<&str>,
) -> Result<models::PagedModelV1Term, Error<TermHierarchicalAncestorsByOntologyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TermHierarchicalAncestorsByOntologyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn term_hierarchical_children_by_ontology(
    configuration: &configuration::Configuration,
    onto: &str,
    iri: Option<&str>,
    short_form: Option<&str>,
    ...
    id: Option<&str>,
    lang: Option<&str>,
) -> Result<models::PagedModelV1Term, Error<TermHierarchicalChildrenByOntologyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TermHierarchicalChildrenByOntologyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn term_hierarchical_descendants_by_ontology(
    configuration: &configuration::Configuration,
    onto: &str,
    iri: Option<&str>,
    short_form: Option<&str>,
    ...
    id: Option<&str>,
    lang: Option<&str>,
) -> Result<models::PagedModelV1Term, Error<TermHierarchicalDescendantsByOntologyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TermHierarchicalDescendantsByOntologyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn term_parents_by_ontology(
    configuration: &configuration::Configuration,
    onto: &str,
    iri: Option<&str>,
    short_form: Option<&str>,
    ...
    id: Option<&str>,
    lang: Option<&str>,
) -> Result<models::PagedModelV1Term, Error<TermParentsByOntologyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TermParentsByOntologyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub fn terms_by_ontology(
    ...
    lang: Option<&str>,
) -> Result<models::PagedModelV1Term, Error<TermsByOntologyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TermsByOntologyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
